...
func (b *Builder) DebugStack(stack int, msg string) { write(b, stack, TAG_DEBUG, msg) }
func (b *Builder) InfoStack(stack int, msg string)  { write(b, stack, TAG_INFO, msg) }
func (b *Builder) WarnStack(stack int, msg string)  { write(b, stack, TAG_WARN, msg) }
func (b *Builder) ErrorStack(stack int, msg string) { write(b, stack, TAG_ERROR, msg) }
func (b *Builder) FatalStack(stack int, msg string) { write(b, stack, TAG_FATAL, msg) }

func (b *Builder) Bule() *Builder    { b.colorfun = colorized.Blue; return b }
func (b *Builder) Yellow() *Builder  { b.colorfun = colorized.Yellow; return b }
func (b *Builder) Green() *Builder   { b.colorfun = colorized.Green; return b }
func (b *Builder) Magenta() *Builder { b.colorfun = colorized.Magenta; return b }
func (b *Builder) Cyan() *Builder    { b.colorfun = colorized.Cyan; return b }
func (b *Builder) Gray() *Builder    { b.colorfun = colorized.Gray; return b }
func (b *Builder) White() *Builder   { b.colorfun = colorized.White; return b }
func (b *Builder) Red() *Builder     { b.colorfun = colorized.Red; return b }
